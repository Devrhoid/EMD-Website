...
<head>
  ...
  .table-hover{text-align: center; margin: 0px auto;}
  ...
  <div class="container-fluid">
    ...
    <div>
      <ul class="nav nav-tabs">
        ...
        <li class='active'><a href="select_unit.php">Data</a></li>
...
<div class="container" style="width:1100px;"> <!-- Start of Container Div-->
	...
	<div id="header">
		...
		<h3>Data Table</h3>
    		...
    		<h4 style="text-align: center;">The table below shows the last fifty readings for data from sensors in the UWI Monitoring Network.</h4>
    	</div>
<!--Php Functions to Create Tables from Data-->
<?php
	
	include 'databaseHandle.php';
	$sqlQuery = "SELECT * FROM `uwienvironmentalmonitoring` ORDER BY `Time` DESC LIMIT 0, 50"; //200 represents the number of results to display. 
	...
	echo "<table border=1 class='table-striped table-hover table-condensed'><tr> <th>Unit ID</th> <th>Unit Name</th> <th style=\"width:120px;\">Upload Date</th> <th style=\"width:120px;\">Time (24Hrs)</th> <th> Temperature (*C)</th> <th>Conductivity (uS/cm)</th> <th>Dissolved Oxygen (%sat)</th> <th>PH (units)</th> <th>PH (mV)</th> <th>Cable Voltage (V)</th> <tr>";
